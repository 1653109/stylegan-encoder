...
def main():
    ...
    parser.add_argument('--logo_mask', default=False, help='Generate a mask for predicting only the logo area', type=str2bool, nargs='?', const=True)
    ...
    tflib.init_tf()
    with open_file_or_url(args.model_url) as f:
